...
export const Footer = () => {
    ...
    return (
        <footer className="pt-5 relative z-30 bg-gray-800">
                    ...
                    <div className="text-white">
                        ...
                        <div>
                            <div className="col-start-5 col-end-7 flex items-center">
                                <a className="text-center text-sm pb-2" href="#about">{t('Home')}</a>
                            </div>
                            <div className="col-start-5 col-end-7 flex items-center">
                    ...
                    <div>
                        ...
                        <div className="text-white">
                            ...
                            <div className="flex items-center justify-between gap-5 col-start-8 col-end-10 row-start-3 row-end-4 text-left">
                                ...
                                <p className="text-xs col-start-6 col-end-12 w-full">{t('154th Street #21 South 22 Ibagué-Tolima')}</p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="z-50 relative text-left text-lg p-5 flex flex-col md:flex-row justify-between items-start gap-2">
                <div className="text-left">
                    <p className="text-white text-sm">&copy; Red Hat It Solutions {date}. {t('All rights reserved')}</p>
                </div>
                <div className="flex gap-7">
                    <div className="flex items-center justify-evenly gap-5 col-start-11 col-end-13 row-start-1 row-end-2 text-right">
                    ...
                    <div className="flex items-center justify-evenly gap-5 col-start-11 col-end-13 row-start-2 row-end-3 text-right">
                    ...
                    <div className="flex items-center justify-evenly gap-5 col-start-11 col-end-13 row-start-3 row-end-4 text-right">
