    ...
    return (
        <section className="flex flex-col md:flex-row">
            <div className="container mx-auto md:max-w-[700px] xl:max-w-[1200px] my-20 md:my-32">
                <Title text="Capabilities" center={true} />
                <div className="flex flex-col md:grid md:grid-cols-3 gap-10">
                    <Card height={'450'} titleCard={t('Back-end development')} textCard={t('Development of managed/unmanaged applications, Windows Forms, ASP.NET, MVC & Web API, Razor/Blazor, SPA (JavaScript). Solid experience in Go (Golang) for the development of efficient and highly concurrent solutions.')}> 
                    ...
                    <Card height={'450'} titleCard={t('Front-end development')} textCard={t('Design and development of responsive web applications for exceptional user experiences. Implementation of recognized frameworks such as Vue, React, Angular, and Knockout for modern and high-performance interfaces.')}> 
                        <div className="flex flex-wrap -mt-10 gap-5">
                    ...
                    <Card height={'450'} titleCard={t('Devops expertise')} textCard={t('Design and implementation of DevOps culture through CI/CD automation. Management of source code repositories, infrastructure cost optimization, monitoring, and quality gates.')}> 
                        <div className="flex flex-wrap -mt-10 gap-5">
                    ...
                    <Card height={'450'} titleCard={t('Cloud solutions')} textCard={t('Implementation of application servers, domain Capacitys, database/file/storage solutions, IaaS, backup and recovery. Resource monitoring, information security strategies, ITSM integration, IaaC.')}> 
                        <div className="flex flex-wrap -mt-10 gap-5">
                    ...
                    <Card height={'450'} titleCard={t('Mobile solutions')} textCard={t('Development of hybrid apps for increased productivity and lower maintenance costs. Development of native apps for faster execution and full utilization of device features.')}> 
                        <div className="flex flex-wrap -mt-10 gap-5">
                            <img className="cursor-pointer w-2/12" alt="Capacity Image" src={react} />
                            <img className="cursor-pointer w-2/12" alt="Capacity Image" src={flutter} />
                        </div>
                    </Card>
                    <Card height={'450'} titleCard={t('QA automation & performance testing')} textCard={t('Automation of non-functional and performance testing, recording and management of test cases, automation of business workflow.')}> 
                        <div className="flex flex-wrap -mt-10 gap-5">
                            <img className="cursor-pointer w-4/12" alt="Capacity Image" src={selenium} />
                        </div>
                    </Card>
                    <Card height={'450'} titleCard={t('User centric experience design')} textCard={t('Creation of digital products focused on maximizing usability through accessibility, ease, and attractive design.')}> 
                        <div className="flex flex-wrap -mt-10 gap-5">
                    ...
                    <Card height={'450'} titleCard={t('Agile frameworks implementation')} textCard={t('Extensive experience in executing agile initiatives under different frameworks, facilitating efficient and high-productivity workflows.')}> 
                        <div className="flex flex-wrap -mt-10 gap-5">
