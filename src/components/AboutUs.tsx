...
export const AboutUs = () => {
    ...
    return (
        <section id="about" className="flex flex-col md:flex-row-reverse gap-10 container mx-auto p-5 md:p-0 md:max-w-[700px] xl:max-w-[1200px] pt-10 md:py-20">
            <div className="flex flex-col md:pt-28">
                <h2 className="mb-10 text-2xl lg:text-3xl font-mono font-bold capitalize">{t('About us')}</h2>
            ...
            <div>
                <img className="w-[1000px] lg:w-[1500px] h-[500px] rounded-lg object-cover object-center cursor-pointer" src={about} alt="Hero Image" loading="lazy"/>
            </div>
        </section>
    )
}
