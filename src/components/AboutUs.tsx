    ...
    return (
        <section id="about" className="flex flex-col md:flex-row gap-10 container mx-auto p-5 md:p-0 md:max-w-[700px] xl:max-w-[1200px] pt-10 md:py-20">
            <div className="flex flex-col justify-center">
                <h2 className="mb-10 text-2xl font-bold">{t('About Us')}</h2>
                ...
                <a className="bg-red-500 hover:bg-red-600 text-white rounded-lg p-3 w-6/12 mx-auto md:mx-0 lg:w-3/12 mt-10 md:mt-8" href="#about">
                    {t('Read more')}
