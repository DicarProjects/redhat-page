...
import JuanManuelImagege from '../assets/img/TeamMembers/JuanManuelGarcia.jpg';
import HarolImagege from '../assets/img/TeamMembers/HarolCartagena.jpg';
import AOS from 'aos';
  ...
  return (
    <section className="container mx-auto md:max-w-[700px] xl:max-w-[1200px] my-10 md:my-32">
      ...
      <div className="flex flex-col md:grid md:grid-cols-3 gap-5 justify-center items-center pt-20">
        ...
        <MemberCard name='Juan Manuel García' position='Frontend Developer'imageSrc={JuanManuelImagege}/>
        <MemberCard name='Diego Alejandro Cardona' position='Backend Architect' imageSrc={DiegoImage}/>
        <MemberCard name='Harol Guzmán Cartagena' position='Backend Developer' imageSrc={HarolImagege}/>
      </div>
    </section>
  )
}
