    ...
    return (
        <section className="flex flex-col md:flex-row">
            <div className="container mx-auto md:max-w-[700px] xl:max-w-[1200px] my-20 md:my-32">
                ...
                <Card height={'500'} titleCard={t('Mobile app development')} textCard={t('Taking mobile application development to the next level, our team of experts not only focuses on creating custom applications for iOS and Android but also delves into user experience, security, and performance. From internal applications to market-targeted products, our commitment is to deliver solutions that not only meet but exceed your expectations.')}> 
                    <img className="cursor-pointer" alt="Service Image" src={mobile} />
                </Card>
                <Card height={'500'} titleCard={t('Web app development')} textCard={t('Excelling in the creation of exceptional web applications, our team of developers collaborates closely with you to understand your business goals and craft tailored web solutions. Utilizing the latest technologies, we ensure web applications that not only perform well but also provide an exceptional user experience, optimizing your customers interaction with your brand.')}> 
                    <img className="cursor-pointer" alt="Service Image" src={web} />
                </Card>
                <Card height={'500'} titleCard={t('Custom software development')} textCard={t('Believing in the uniqueness of every business, our custom software development services are designed to provide solutions that align perfectly with your unique business processes. We work closely with you to understand your needs and provide solutions that drive efficiency and productivity in your company.')}> 
                ...
                <Card height={'500'} titleCard={t('Ecommerce development')} textCard={t('Understanding the importance of e-commerce in the digital era, from creating online stores to developing custom e-commerce platforms, our team works to boost your operations and maximize your presence in the online market. Our commitment is to deliver solutions that not only power your online sales but also enhance the customer experience.')}> 
                    <img className="cursor-pointer" alt="Service Image" src={ecommerce} />
                </Card>
                <Card height={'500'} titleCard={t('Technology consulting')} textCard={t('Offering technology consulting services to assess and enhance your business operations, our team of expert consultants works with you to identify optimization opportunities and recommend strategic solutions. Focusing on driving innovation and efficiency in your company, we help you maintain a competitive edge in an ever-evolving technological landscape.')}> 
