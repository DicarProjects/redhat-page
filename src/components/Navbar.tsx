...
import logo from '../assets/img/Logo-BlackAndRed-Principal.png';
        ...
        <>
            ...
            <div className={`fixed top-0 left-0 w-60 h-full bg-white pt-5 transform transition-transform ease-in-out ${isActiveMenu ? 'translate-x-0' : '-translate-x-60'} z-[100] flex flex-col`} style={{zIndex: 9999}}>
                ...
                <div className="pt-10 flex flex-col text-left">
                    {isHome ? <a className="text-gray-500 hover:text-gray-600 cursor-pointer p-3 hover:bg-gray-300 " href="#about">{t('About us')}</a> : <Link to="/" className="text-gray-500 hover:text-gray-600 cursor-pointer p-3 hover:bg-gray-300 ">{t('About us')}</Link>}
                    <Link to="/services" className="text-gray-500 hover:text-gray-600 cursor-pointer p-3 hover:bg-gray-300 ">{t('Services')}</Link>
                    <Link to="/capabilities" className="text-gray-500 hover:text-gray-600 cursor-pointer p-3 hover:bg-gray-300 ">{t('Capabilities')}</Link>
                    ...
                    <Link to="/contactus" className="text-gray-500 hover:text-gray-600 cursor-pointer p-3 hover:bg-gray-300 ">{t('Contact us')}</Link>
                    <div className="text-gray-500 hover:text-gray-600 cursor-pointer flex  gap-3 mx-auto w-full p-3 hover:bg-gray-300 " onClick={() => handleLanguageSelect(i18n.language === 'en' ? 'es' : 'en' )}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 512 512">
