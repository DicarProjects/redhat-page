  ...
  return (
    <section className="flex flex-col md:flex-row container mx-auto md:max-w-[700px] xl:max-w-[1200px] mt-10">
      <div className="flex flex-col flex-1 items-start gap-5 m-10 md:m-0 md:mt-10">
        ...
        <p className="text-gray-400"><span className="font-bold text-black">{t('Phone')}:</span> +57 312 2538120</p>
        <p className="text-gray-400"><span className="font-bold text-black">{t('Email')}:</span> contact@redhatitsolutions.com</p>
      </div>
